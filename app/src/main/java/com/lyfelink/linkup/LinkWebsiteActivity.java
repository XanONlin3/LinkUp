 ...
 * Created by Jan on 10.07.2014.
 */
public class LinkWebsiteActivity extends Activity {
    ...
    void checkFieldForEmptyValue(){
        ...
        if(s.equals("") || s.equals("http://")){
            saveBtn.setEnabled(false);
            saveBtn.setBackgroundColor(Color.GRAY);
        }
        else {
            saveBtn.setEnabled(true);
            //saveBtn.setBackgroundColor(Color.CYAN);
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        tvInst.setText(res.getString(R.string.website_instruction));

        etStr = (EditText)findViewById(R.id.et_txtStr);
        etStr.setText(res.getString(R.string.httpText));

        //InputMethodManager imm = (InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE);
        //imm.showSoftInput(etStr, InputMethodManager.SHOW_IMPLICIT);
